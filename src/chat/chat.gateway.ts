...
//       const groupsMessage: Array<GroupMessageDto[]> =
//         await Promise.all(groupMessagePromise);
...
//       const friendsMessage: Array<FriendMessageDto[]> =
//         await Promise.all(friendMessagePromise);
